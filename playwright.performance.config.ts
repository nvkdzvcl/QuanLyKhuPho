...
/**
 * Playwright configuration for deterministic API performance and latency acceptance testing (SRS NFR-03).
 *
...
export default defineConfig({
  testDir: './apps/api/test/performance',
  testMatch: /api-latency\.spec\.ts$/,
  timeout: 120_000,
  expect: {
    timeout: 10_000,
  },
  ...
  webServer: {
    ...
    env: {
      ...
      CORS_ORIGIN:
        'http://127.0.0.1:3100,http://localhost:3100,http://localhost:4000,http://127.0.0.1:4000',
